...
def insert_test_data():
    test_users = [
        {"name": "Alice", "email": "alice@example.com", "phone": "1234567890", "address": "123 Main St", "country": "Wonderland"},
        {"name": "Bob", "email": "bob@example.com", "phone": "0987654321", "address": "456 Elm St", "country": "Builderland"}
    ]
...
if __name__ == "__main__":
    create_db_table()
    insert_test_data()  # Add test data after creating the table
    app.run()  # run app
